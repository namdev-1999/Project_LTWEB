...
<div class="limiter">
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50 " style="margin-top: 5%">
            <p></p>
            <p></p>
            <blockquote>
                    <%
                    ...
                    if (err == null)
                        err = "";
                %>
                <form class="login100-form validate-form" action="<%=Util.fullPath("ChangePass")%>" method="post">
                <span class="login100-form-title p-b-59">
						Đổi mật khẩu
                </span>

                    <div class="wrap-input100 validate-input" data-validate="Bắt buộc">
                        <span class="label-input100">Mật khẩu hiện tại </span>
                        <p class="label-input100" style="color:#db030b;"><%=err%></p>
                        <input class="input100" type="text" name="curPass" placeholder="Mật khẩu hiện tại">
