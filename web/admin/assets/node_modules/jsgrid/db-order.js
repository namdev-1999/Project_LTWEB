(function() {
    ...
    var db_order = {
        ...
        loadData: function(filter) {
            return $.grep(this.order, function(client) {
                return (!filter.Id_Order || client.Id_Order.indexOf(filter.Id_Order) > -1)
                    && (!filter.Id_Product || client.Id_Product.indexOf(filter.Id_Product) > -1)
                    && (!filter.Customer || client.Customer.indexOf(filter.Customer) > -1)
                    && (!filter.Customer || client.Customer.indexOf(filter.Customer) > -1)
                    && (!filter.Total || client.Total.indexOf(filter.Total) > -1)
        ...
        insertItem: function(insertingProduct) {
            this.order.push(insertingProduct);
        },

        updateItem: function(updatingProduct) { },

        deleteItem: function(deletingProduct) {
            var productIndex = $.inArray(deletingProduct, this.order);
    ...
    db_order.order = [
        ...
        },
        {
            "Id_Order" : "s1109",
            "Id_Product" : "P004",
            "Customer" : "Phạm Nguyễn Bửu Điền",
            "Address":"Tp.HCM",
            "Total": "1.000.000đ",
            "Status":true
        },
