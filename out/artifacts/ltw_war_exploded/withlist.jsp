    ...
    <div class="container">
        ...
        <div class="row path">
            <div class="col-lg-3 col-12 md-mt-40 sm-mt-40">
                ...
                <span>/</span>
                <span>
                    <a class="active " href="cart.jsp">SẢN PHẨM ƯA THÍCH</a>
                </span>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-12 ftco-animate">
                ...
                <div class="cart-list">
                    <table class="table">
                        ...
                        <%for (Item item : wishlist.getData()) {%>
                        <tbody>
                        <tr class="text-center">
                            ...
                            <td class="quantity">
                                <div class="input-group bootstrap-touchspin">
                                       ...
                                       <span class="input-group-btn">
                                             <form action="<%=Util.fullPath("WishlistUpdate")%>">
                            ...
                            <td class="total"><%=shoe.insert(item.total())%><%=" "%>đ
                            </td>

                            <td class="product-remove">
                                <a href="Cart?command=addByWishList&id=<%=item.getShoe().getId()%>&size=<%=item.getSize()%>&qty=<%=item.getQuantity()%>"
                                    title="Add To Shopping Cart"><i
                                    class="fas fa-plus-circle"
                                ></i></a>

                                <a href="WishlistUpdate?command=remove&id=<%=item.getShoe().getId()%>&size=<%=item.getSize()%>"
                                    title="Remove"><i
