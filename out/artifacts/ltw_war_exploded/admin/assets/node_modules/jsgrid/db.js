(function() {
    ...
    var db = {
        ...
        loadData: function(filter) {
            return $.grep(this.product, function(client) {
                return (!filter.Id_Product || client.Id_Product.indexOf(filter.Id_Product) > -1)
                    && (!filter.Product || client.Product.indexOf(filter.Product) > -1)
                    && (!filter.Size || client.Size === filter.Size)
        ...
        insertItem: function(insertingProduct) {
            this.product.push(insertingProduct);
        },
