...
<%@ page import="vn.nlu.banana.model.Comment" %>
<%@ page import="vn.nlu.banana.model.ListComment" %>
...
<head>
    ...
    <title>Admin - Quản lý Comment</title>
...
<%
    //    List<Shoe> list;
    List<Comment> listComment = ListComment.getListComment();
    String numPage = "";
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor" title="Quản lý comment">Quản lý comment</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Trang chủ</a></li>
                            <li class="breadcrumb-item active" title="Quản lý comment">Quản lý comment</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div id="basicgrid" class="jsgrid"
                                ...
                                <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                    <table class="jsgrid-table table table-striped table-hover">
                                        <tr class="jsgrid-header-row">
                                            ...
                                            <th class="jsgrid-header-cell jsgrid-align-center jsgrid-header"
                                                style="width: 40px;">ID sản phẩm
                                            </th>
                                            <th class="jsgrid-header-cell jsgrid-align-left jsgrid-header"
                                                style="width: 150px;">Tên người bình luận
                                            </th>
                                            <th class="jsgrid-header-cell jsgrid-align-right jsgrid-header"
                                                style="width: 60px;">Nội dung
                                            </th>
                                            <th class="jsgrid-header-cell jsgrid-align-right jsgrid-header"
                                                style="width: 60px;">Ngày bình luận
                                            </th>
                                ...
                                <div class="jsgrid-grid-body" style="height: 394px;">
                                    <table class="jsgrid-table table table-striped table-hover">
                                        ...
                                        <%
                                            int count = 0;
                                            for (int i = 15 * (Integer.parseInt(numPage) - 1); i < listComment.size(); i++) {
                                        ...
                                        <tr class="jsgrid-row" style="height: 50px;">
                                            <td class="jsgrid-cell jsgrid-align-center"
                                                style="width: 40px;"><%=comment.getId()%>
                                            </td>
                                            <td class="jsgrid-cell jsgrid-align-center"
                                                style="width: 40px;"><%=comment.getIdProduct()%>
                                            </td>
                                            <td class="jsgrid-cell jsgrid-align-left"
                                                style="width: 150px;"><%=comment.getUsername()%>
                                            </td>
                                            <td class="jsgrid-cell jsgrid-align-left"
                                                style="width: 60px;"><%=comment.getContent()%>
                                            </td>
                                            <td class="jsgrid-cell jsgrid-align-left"
                                                style="width: 60px;"><%=comment.getDate()%>
                                            </td>
                                            <td class="jsgrid-cell jsgrid-control-field jsgrid-align-center"
                                                style="width: 60px;">
                                                <a onclick="return confirm('Are you sure you want to delete this?')"
                                                   href=<%=Util.fullPath("Delete?del=" + comment.getId() + "&command=comment")%>>
                                ...
                                <%--Pagination--%>
                                <% double countPage = 0;
                                    if (listComment.size() % 15 == 0) {
                                        countPage = (double) listComment.size() / (double) 15;
                                    } else {
                                        countPage = (double) listComment.size() / (double) 15 + 1;
                                    }
                                ...
                                <div class="jsgrid-pager-container" style="">
                                    <div class="jsgrid-pager">Trang:
                                        <span class="jsgrid-pager-nav-button"><a
                                                ...
                                                href="comment-manage.jsp?page=<%=1%>">Đầu</a></span>
                                        <span class="jsgrid-pager-nav-button"><a
                                                class="btn <%if (Integer.parseInt(numPage)==1) {%> disabled <%}%>"
                                                href="comment-manage.jsp?page=<%=(Integer.parseInt(numPage)-1)%>">Trước</a></span>
                                        ...
                                        <span class="jsgrid-pager-page"><a
                                                href="comment-manage.jsp?&page=<%=j%>"><%=j%></a></span>
                                        <% }
                                        }
                                        %>
                                        <span class="jsgrid-pager-nav-button"><a
                                                class="btn <%if (Integer.parseInt(numPage)==(int)countPage) {%> disabled <%}%>"
                                                href="comment-manage.jsp?page=<%=(Integer.parseInt(numPage)+1)%>">Sau</a></span>
                                        <span class="jsgrid-pager-nav-button"><a
                                                class="btn <%if (Integer.parseInt(numPage)==(int)countPage) {%> disabled <%}%>"
                                                href="comment-manage.jsp?page=<%=(int) countPage%>">Cuối</a></span>
